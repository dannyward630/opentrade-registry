...
The released v1.0.1 package family contains 11 public packages: core, registry orchestration, SQLite storage, CLI, and seven supported adapters. Three additional adapter-research packages remain private and are not release artifacts.

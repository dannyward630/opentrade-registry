...
- `51` sources are registry-only metadata entries.
- `5` sources have implemented adapters.
- `4` unimplemented sources are currently bulk-shaped adapter candidates according to `corepack pnpm source:quality`.

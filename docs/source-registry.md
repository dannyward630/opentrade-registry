...
The current registry contains `132` terminal entries: `9` implemented Level 4 adapters and `123` blockers. See the generated [source-status matrix](source-status-matrix.md).

...
The current registry contains `138` terminal entries: `9` implemented Level 4 adapters and `129` blockers. See the generated [source-status matrix](source-status-matrix.md).

...
The current registry contains `104` terminal entries: `9` implemented Level 4 adapters and `95` blockers. See the generated [source-status matrix](source-status-matrix.md).

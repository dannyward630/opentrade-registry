...
The current registry contains `161` terminal entries: `9` implemented Level 4 adapters and `152` blockers. See the generated [source-status matrix](source-status-matrix.md).

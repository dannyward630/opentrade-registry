...
The current registry contains `156` terminal entries: `9` implemented Level 4 adapters and `147` blockers. See the generated [source-status matrix](source-status-matrix.md).

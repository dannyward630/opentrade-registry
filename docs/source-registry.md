...
The current registry contains `98` terminal entries: `9` implemented Level 4 adapters and `89` blockers. See the generated [source-status matrix](source-status-matrix.md).

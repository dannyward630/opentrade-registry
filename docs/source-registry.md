...
The current registry contains `149` terminal entries: `9` implemented Level 4 adapters and `140` blockers. See the generated [source-status matrix](source-status-matrix.md).

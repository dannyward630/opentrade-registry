...
The current registry contains `148` terminal entries: `9` implemented Level 4 adapters and `139` blockers. See the generated [source-status matrix](source-status-matrix.md).

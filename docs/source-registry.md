...
The current registry contains `155` terminal entries: `9` implemented Level 4 adapters and `146` blockers. See the generated [source-status matrix](source-status-matrix.md).

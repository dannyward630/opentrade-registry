...
The current registry contains `117` terminal entries: `9` implemented Level 4 adapters and `108` blockers. See the generated [source-status matrix](source-status-matrix.md).

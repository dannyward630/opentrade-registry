...
The current registry contains `127` terminal entries: `9` implemented Level 4 adapters and `118` blockers. See the generated [source-status matrix](source-status-matrix.md).

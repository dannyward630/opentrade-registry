...
The current registry contains `77` terminal entries: `9` implemented Level 4 adapters and `68` blockers. See the generated [source-status matrix](source-status-matrix.md).

...
The current registry contains `153` terminal entries: `9` implemented Level 4 adapters and `144` blockers. See the generated [source-status matrix](source-status-matrix.md).

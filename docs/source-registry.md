...
The current registry contains `128` terminal entries: `9` implemented Level 4 adapters and `119` blockers. See the generated [source-status matrix](source-status-matrix.md).

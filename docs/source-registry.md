...
The current registry contains `152` terminal entries: `9` implemented Level 4 adapters and `143` blockers. See the generated [source-status matrix](source-status-matrix.md).

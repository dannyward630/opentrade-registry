...
The current registry contains `61` terminal entries: `9` implemented Level 4 adapters and `52` blockers. See the generated [source-status matrix](source-status-matrix.md).

...
The current registry contains `160` terminal entries: `9` implemented Level 4 adapters and `151` blockers. See the generated [source-status matrix](source-status-matrix.md).

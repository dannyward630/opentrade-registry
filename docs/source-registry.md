...
The current registry contains `158` terminal entries: `9` implemented Level 4 adapters and `149` blockers. See the generated [source-status matrix](source-status-matrix.md).

...
The current registry contains `130` terminal entries: `9` implemented Level 4 adapters and `121` blockers. See the generated [source-status matrix](source-status-matrix.md).

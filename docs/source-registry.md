...
The current registry contains `83` terminal entries: `9` implemented Level 4 adapters and `74` blockers. See the generated [source-status matrix](source-status-matrix.md).

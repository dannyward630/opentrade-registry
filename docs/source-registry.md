...
The current registry contains `146` terminal entries: `9` implemented Level 4 adapters and `137` blockers. See the generated [source-status matrix](source-status-matrix.md).

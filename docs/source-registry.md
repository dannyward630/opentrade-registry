...
The current registry contains `162` terminal entries: `9` implemented Level 4 adapters and `153` blockers. See the generated [source-status matrix](source-status-matrix.md).

...
The current registry contains `109` terminal entries: `9` implemented Level 4 adapters and `100` blockers. See the generated [source-status matrix](source-status-matrix.md).

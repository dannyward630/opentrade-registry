...
The current registry contains `59` terminal entries: `9` implemented Level 4 adapters and `50` blockers. See the generated [source-status matrix](source-status-matrix.md).

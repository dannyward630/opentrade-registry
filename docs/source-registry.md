...
The current registry contains `129` terminal entries: `9` implemented Level 4 adapters and `120` blockers. See the generated [source-status matrix](source-status-matrix.md).

...
The current registry contains `163` terminal entries: `9` implemented Level 4 adapters and `154` blockers. See the generated [source-status matrix](source-status-matrix.md).

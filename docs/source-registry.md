...
The current registry contains `80` terminal entries: `9` implemented Level 4 adapters and `71` blockers. See the generated [source-status matrix](source-status-matrix.md).

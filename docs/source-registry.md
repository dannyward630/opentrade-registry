...
The current registry contains `131` terminal entries: `9` implemented Level 4 adapters and `122` blockers. See the generated [source-status matrix](source-status-matrix.md).

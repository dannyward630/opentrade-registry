...
The current registry contains `134` terminal entries: `9` implemented Level 4 adapters and `125` blockers. See the generated [source-status matrix](source-status-matrix.md).

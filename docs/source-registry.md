...
The current registry contains `150` terminal entries: `9` implemented Level 4 adapters and `141` blockers. See the generated [source-status matrix](source-status-matrix.md).

...
The current registry contains `94` terminal entries: `9` implemented Level 4 adapters and `85` blockers. See the generated [source-status matrix](source-status-matrix.md).

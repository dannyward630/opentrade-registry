...
The current registry contains `113` terminal entries: `9` implemented Level 4 adapters and `104` blockers. See the generated [source-status matrix](source-status-matrix.md).

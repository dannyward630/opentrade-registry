...
The current registry contains `74` terminal entries: `9` implemented Level 4 adapters and `65` blockers. See the generated [source-status matrix](source-status-matrix.md).

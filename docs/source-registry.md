...
The current registry contains `89` terminal entries: `9` implemented Level 4 adapters and `80` blockers. See the generated [source-status matrix](source-status-matrix.md).

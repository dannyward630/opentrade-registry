...
The current registry contains `103` terminal entries: `9` implemented Level 4 adapters and `94` blockers. See the generated [source-status matrix](source-status-matrix.md).

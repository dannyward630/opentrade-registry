...
The current registry contains `86` terminal entries: `9` implemented Level 4 adapters and `77` blockers. See the generated [source-status matrix](source-status-matrix.md).

...
The current registry contains `142` terminal entries: `9` implemented Level 4 adapters and `133` blockers. See the generated [source-status matrix](source-status-matrix.md).

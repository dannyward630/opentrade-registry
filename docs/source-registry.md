...
The current registry contains `100` terminal entries: `9` implemented Level 4 adapters and `91` blockers. See the generated [source-status matrix](source-status-matrix.md).

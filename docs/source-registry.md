...
The current registry contains `85` terminal entries: `9` implemented Level 4 adapters and `76` blockers. See the generated [source-status matrix](source-status-matrix.md).

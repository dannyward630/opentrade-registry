...
OpenTrade Registry currently tracks `134` official sources covering all 50 states, DC, and five major U.S. territories. Every source has a terminal, evidence-backed outcome:

- `9` implemented adapters, all reviewed at adapter quality Level 4;
- `2` local-file adapters;
- `7` explicit network opt-in adapters;
- `125` blocked sources with documented legal, technical, access-control, scope, or source-stability evidence;

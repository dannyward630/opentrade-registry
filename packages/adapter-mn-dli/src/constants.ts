...
export const MN_DLI_SOURCE_ENTRY: SourceRegistryEntry = {
  ...
  rateLimitNotes: "The official page links a nightly ZIP archive. The v1 adapter accepts extracted CSV/XLSX files; archive resolution remains explicit and caller-managed.",

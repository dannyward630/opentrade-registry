...
export const IN_PLA_SOURCE_ENTRY: SourceRegistryEntry = {
  ...
  rateLimitNotes: "Bulk downloads require accepting official conditions and payment. The project does not treat that gated path as a supported adapter source.",
  ...
  officialBulkDownloadNotes: "Indiana offers license data downloads under user conditions and paid pricing. Those gated downloads are not a supported adapter path.",
  researchNotes: "A historical hand-authored parser fixture does not establish compatibility with a paid official download or authorization to redistribute it.",
  ...
  verificationNotes: "No supported sync or verification adapter is exposed for the gated download path.",
  ...
  researchEvidence: [
    {
      ...
      "note": "Official download page reviewed; downloads require acceptance of conditions and payment."
    }
  ],
  blocker: {
    code: "terms",
    summary: "Bulk license files are agreement- and payment-gated, so OpenTrade does not expose them as a supported adapter path.",
    evidenceUrls: ["https://www.in.gov/pla/license/download-license-files/"],
  },

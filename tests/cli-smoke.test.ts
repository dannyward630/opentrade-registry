...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 146 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(137);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 146");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 146");
    expect(readiness).toContain("blocked sources: 137");
    ...
    expect(readiness).toContain("- blocked: 137");
    ...
    expect(json.sourceCount).toBe(146);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(137);

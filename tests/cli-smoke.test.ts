...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 134 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(125);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 134");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 134");
    expect(readiness).toContain("blocked sources: 125");
    ...
    expect(readiness).toContain("- blocked: 125");
    ...
    expect(json.sourceCount).toBe(134);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(125);

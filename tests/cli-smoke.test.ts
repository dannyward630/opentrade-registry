...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 127 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(118);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 127");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 127");
    expect(readiness).toContain("blocked sources: 118");
    ...
    expect(readiness).toContain("- blocked: 118");
    ...
    expect(json.sourceCount).toBe(127);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(118);

...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 77 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(68);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 77");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 77");
    expect(readiness).toContain("blocked sources: 68");
    ...
    expect(readiness).toContain("- blocked: 68");
    ...
    expect(json.sourceCount).toBe(77);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(68);

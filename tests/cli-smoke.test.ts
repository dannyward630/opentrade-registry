...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 148 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(139);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 148");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 148");
    expect(readiness).toContain("blocked sources: 139");
    ...
    expect(readiness).toContain("- blocked: 139");
    ...
    expect(json.sourceCount).toBe(148);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(139);

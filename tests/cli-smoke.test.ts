...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 150 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(141);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 150");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 150");
    expect(readiness).toContain("blocked sources: 141");
    ...
    expect(readiness).toContain("- blocked: 141");
    ...
    expect(json.sourceCount).toBe(150);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(141);

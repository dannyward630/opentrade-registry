...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 113 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(104);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 113");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 113");
    expect(readiness).toContain("blocked sources: 104");
    ...
    expect(readiness).toContain("- blocked: 104");
    ...
    expect(json.sourceCount).toBe(113);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(104);

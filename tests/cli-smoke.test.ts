...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 70 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(61);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 70");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 70");
    expect(readiness).toContain("blocked sources: 61");
    ...
    expect(readiness).toContain("- blocked: 61");
    ...
    expect(json.sourceCount).toBe(70);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(61);

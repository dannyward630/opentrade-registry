...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 128 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(119);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 128");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 128");
    expect(readiness).toContain("blocked sources: 119");
    ...
    expect(readiness).toContain("- blocked: 119");
    ...
    expect(json.sourceCount).toBe(128);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(119);

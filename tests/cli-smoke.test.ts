...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 158 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(149);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 158");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 158");
    expect(readiness).toContain("blocked sources: 149");
    ...
    expect(readiness).toContain("- blocked: 149");
    ...
    expect(json.sourceCount).toBe(158);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(149);

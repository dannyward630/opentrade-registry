...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 138 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(129);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 138");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 138");
    expect(readiness).toContain("blocked sources: 129");
    ...
    expect(readiness).toContain("- blocked: 129");
    ...
    expect(json.sourceCount).toBe(138);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(129);

...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 132 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(123);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 132");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 132");
    expect(readiness).toContain("blocked sources: 123");
    ...
    expect(readiness).toContain("- blocked: 123");
    ...
    expect(json.sourceCount).toBe(132);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(123);

...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 117 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(108);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 117");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 117");
    expect(readiness).toContain("blocked sources: 108");
    ...
    expect(readiness).toContain("- blocked: 108");
    ...
    expect(json.sourceCount).toBe(117);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(108);

...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 149 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(140);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 149");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 149");
    expect(readiness).toContain("blocked sources: 140");
    ...
    expect(readiness).toContain("- blocked: 140");
    ...
    expect(json.sourceCount).toBe(149);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(140);

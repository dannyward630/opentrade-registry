...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 109 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(100);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 109");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 109");
    expect(readiness).toContain("blocked sources: 100");
    ...
    expect(readiness).toContain("- blocked: 100");
    ...
    expect(json.sourceCount).toBe(109);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(100);

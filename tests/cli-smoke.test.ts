...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 104 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(95);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 104");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 104");
    expect(readiness).toContain("blocked sources: 95");
    ...
    expect(readiness).toContain("- blocked: 95");
    ...
    expect(json.sourceCount).toBe(104);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(95);

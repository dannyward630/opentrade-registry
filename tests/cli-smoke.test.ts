...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 160 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(151);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 160");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 160");
    expect(readiness).toContain("blocked sources: 151");
    ...
    expect(readiness).toContain("- blocked: 151");
    ...
    expect(json.sourceCount).toBe(160);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(151);

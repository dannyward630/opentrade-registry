...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 68 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(59);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 68");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 68");
    expect(readiness).toContain("blocked sources: 59");
    ...
    expect(readiness).toContain("- blocked: 59");
    ...
    expect(json.sourceCount).toBe(68);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(59);

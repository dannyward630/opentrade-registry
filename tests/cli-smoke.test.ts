...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 142 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(133);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 142");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 142");
    expect(readiness).toContain("blocked sources: 133");
    ...
    expect(readiness).toContain("- blocked: 133");
    ...
    expect(json.sourceCount).toBe(142);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(133);

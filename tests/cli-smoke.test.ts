...
describe("opentrade CLI", () => {
  ...
  it("lists, shows, and validates sources", () => {
    ...
    expect(runCli(["sources", "validate"]).stdout).toContain("Validated 131 source registry entries.");
  ...
  it("filters source listings for discovery workflows", () => {
    ...
    expect(blockedJson).toHaveLength(122);
  ...
  it("summarizes terminal source readiness", () => {
    ...
    expect(readiness).toContain("sources: 131");
    expect(readiness).toContain("implemented adapter sources: 9");
    expect(readiness).toContain("terminal source decisions: 131");
    expect(readiness).toContain("blocked sources: 122");
    ...
    expect(readiness).toContain("- blocked: 122");
    ...
    expect(json.sourceCount).toBe(131);
    ...
    expect(json.sourcesByResearchOutcome.blocked).toBe(122);

...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 134) {
    throw new Error(`Packed CLI source registry smoke test expected 134 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

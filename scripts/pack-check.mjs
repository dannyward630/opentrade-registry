...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 148) {
    throw new Error(`Packed CLI source registry smoke test expected 148 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

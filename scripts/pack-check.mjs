...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 146) {
    throw new Error(`Packed CLI source registry smoke test expected 146 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

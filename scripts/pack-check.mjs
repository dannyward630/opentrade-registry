...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 83) {
    throw new Error(`Packed CLI source registry smoke test expected 83 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

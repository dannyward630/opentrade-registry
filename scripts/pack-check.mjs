...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 103) {
    throw new Error(`Packed CLI source registry smoke test expected 103 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

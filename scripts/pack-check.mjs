...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 163) {
    throw new Error(`Packed CLI source registry smoke test expected 163 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

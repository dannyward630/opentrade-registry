...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 158) {
    throw new Error(`Packed CLI source registry smoke test expected 158 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

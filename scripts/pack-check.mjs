...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 104) {
    throw new Error(`Packed CLI source registry smoke test expected 104 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

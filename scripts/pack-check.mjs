...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 129) {
    throw new Error(`Packed CLI source registry smoke test expected 129 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

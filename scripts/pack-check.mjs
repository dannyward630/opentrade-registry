...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 127) {
    throw new Error(`Packed CLI source registry smoke test expected 127 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

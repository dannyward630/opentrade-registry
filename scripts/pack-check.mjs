...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 98) {
    throw new Error(`Packed CLI source registry smoke test expected 98 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 117) {
    throw new Error(`Packed CLI source registry smoke test expected 117 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

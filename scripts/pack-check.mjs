...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 142) {
    throw new Error(`Packed CLI source registry smoke test expected 142 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 149) {
    throw new Error(`Packed CLI source registry smoke test expected 149 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

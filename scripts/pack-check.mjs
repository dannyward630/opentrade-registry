...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 131) {
    throw new Error(`Packed CLI source registry smoke test expected 131 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

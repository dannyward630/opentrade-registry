...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 155) {
    throw new Error(`Packed CLI source registry smoke test expected 155 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

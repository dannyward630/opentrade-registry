...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 113) {
    throw new Error(`Packed CLI source registry smoke test expected 113 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

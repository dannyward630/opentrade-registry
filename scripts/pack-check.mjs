...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 59) {
    throw new Error(`Packed CLI source registry smoke test expected 59 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

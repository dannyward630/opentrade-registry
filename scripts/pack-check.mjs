...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 130) {
    throw new Error(`Packed CLI source registry smoke test expected 130 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

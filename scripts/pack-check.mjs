...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 138) {
    throw new Error(`Packed CLI source registry smoke test expected 138 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 109) {
    throw new Error(`Packed CLI source registry smoke test expected 109 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 68) {
    throw new Error(`Packed CLI source registry smoke test expected 68 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

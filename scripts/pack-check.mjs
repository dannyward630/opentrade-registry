...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 58) {
    throw new Error(`Packed CLI source registry smoke test expected 58 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

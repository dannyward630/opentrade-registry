...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 61) {
    throw new Error(`Packed CLI source registry smoke test expected 61 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

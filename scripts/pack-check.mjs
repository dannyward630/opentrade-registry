...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 152) {
    throw new Error(`Packed CLI source registry smoke test expected 152 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 85) {
    throw new Error(`Packed CLI source registry smoke test expected 85 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

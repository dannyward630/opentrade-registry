...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 161) {
    throw new Error(`Packed CLI source registry smoke test expected 161 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

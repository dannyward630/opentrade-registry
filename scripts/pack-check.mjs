...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 77) {
    throw new Error(`Packed CLI source registry smoke test expected 77 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

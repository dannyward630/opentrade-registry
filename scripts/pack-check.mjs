...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 156) {
    throw new Error(`Packed CLI source registry smoke test expected 156 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

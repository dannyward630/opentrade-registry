...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 153) {
    throw new Error(`Packed CLI source registry smoke test expected 153 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

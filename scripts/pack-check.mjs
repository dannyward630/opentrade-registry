...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 94) {
    throw new Error(`Packed CLI source registry smoke test expected 94 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

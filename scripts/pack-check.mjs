...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 89) {
    throw new Error(`Packed CLI source registry smoke test expected 89 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

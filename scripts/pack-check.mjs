...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 86) {
    throw new Error(`Packed CLI source registry smoke test expected 86 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

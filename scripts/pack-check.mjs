...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 72) {
    throw new Error(`Packed CLI source registry smoke test expected 72 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 162) {
    throw new Error(`Packed CLI source registry smoke test expected 162 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 160) {
    throw new Error(`Packed CLI source registry smoke test expected 160 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

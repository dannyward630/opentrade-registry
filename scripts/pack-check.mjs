...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 132) {
    throw new Error(`Packed CLI source registry smoke test expected 132 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }

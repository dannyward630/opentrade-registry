...
try {
  ...
  if (!Array.isArray(sources) || sources.length !== 150) {
    throw new Error(`Packed CLI source registry smoke test expected 150 entries, received ${Array.isArray(sources) ? sources.length : "invalid JSON"}.`);
  }
